...
// Inline SVG icons (avoids a network round-trip per icon in dev). Zensical's default
// theme icons are lucide (stroke-based; the SCSS .lucide override renders strokes).
...
function searchOverlay(): string {
  ...
  <label class="md-search__button" for="__search">Search</label>
